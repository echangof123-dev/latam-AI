  ...
  return (
    <div className="space-y-8">
      ...
      <details className="card">
        <summary className="cursor-pointer text-lg font-semibold">Crear otro negocio</summary>
        <form action={createTenant} className="grid md:grid-cols-2 gap-4 mt-4">
          <div className="space-y-1">
            <label className="text-sm normal-case tracking-normal">Nombre del negocio</label>
            <input name="name" required placeholder="Veterinaria Luna" className="w-full" />
          </div>
          <div className="space-y-1">
            <label className="text-sm normal-case tracking-normal">Nombre corto (sin espacios)</label>
            <input name="slug" required placeholder="vet-luna" className="w-full" />
          </div>
          <div className="space-y-1">
            <label className="text-sm normal-case tracking-normal">Tipo</label>
          ...
          <div className="space-y-1">
            <label className="text-sm normal-case tracking-normal">Teléfono del negocio</label>
            <input name="phone" required placeholder="+57300..." className="w-full" />
          </div>
          <div className="space-y-1">
            <label className="text-sm normal-case tracking-normal">Correo del dueño</label>
            <input name="ownerEmail" type="email" required placeholder="dueño@negocio.com" className="w-full" />
          </div>
          <div className="space-y-1">
            <label className="text-sm normal-case tracking-normal">Nombre del dueño</label>
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-slate-500 mt-2">Clave inicial del dueño: ejeuno123</p>
          </div>
        </form>
      </details>
          ...
          <article key={t.id} className="card space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400 mt-3">
                Para conectar WhatsApp abre el menú <b>WhatsApp</b>.
              </p>
            </div>
